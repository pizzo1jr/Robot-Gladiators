...
var startGame = function() {
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    ...
    if (playerHealth > 0) {
      ...
      // pass the pickedEnemyName variable into the fight function, where it will assume the value of the enemyName paraameter
  ...
  // after loop ends, we are either out of playerHealth or enemies to fight, so run the endGamefunction
  endGame();
};
